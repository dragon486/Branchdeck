    ...
    <div className="w-full h-full flex-1 min-h-0 relative font-sans select-none flex flex-col">
      ...
      <div className="absolute top-3 left-3 right-3 z-20 pointer-events-auto flex items-center justify-between gap-3 bg-white/95 backdrop-blur-md border border-slate-200/90 p-2 rounded-2xl shadow-sm">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {/* Responsive Compact Search Box */}
          <div className="bg-slate-100/90 border border-slate-200/80 rounded-xl px-2 py-1 flex items-center gap-1 focus-within:bg-white focus-within:border-slate-400 transition-all duration-200 shrink-0">
            ...
            <input
              ...
              className="text-xs bg-transparent border-none outline-none w-16 focus:w-28 placeholder:text-slate-400 font-medium text-slate-800 transition-all duration-200"
            />
            {searchQuery && (
              <button
          ...
          <button
            ...
            className="bg-slate-100 hover:bg-slate-200/80 text-slate-800 text-[10px] font-bold px-2.5 py-1.5 rounded-xl border border-slate-200/80 transition-all flex items-center gap-1.5 shadow-2xs shrink-0 cursor-pointer"
            title="Reset position and fit view to all graph nodes"
          >
            <RefreshCw className="w-3 h-3 text-slate-700 shrink-0" />
            <span className="hidden sm:inline">Center Camera</span>
          </button>
